...
export const BG_COLOR_COOKIE_KEY = 'bg-color-preference';
...
export const setBgColorPreference = (bgColor: string) => {
	deleteCookie(BG_COLOR_COOKIE_KEY);
	setCookie(BG_COLOR_COOKIE_KEY, bgColor, 365);
};
